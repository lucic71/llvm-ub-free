...
; RUN: opt -S < %s -basic-aa -gvn -dce -disable-object-based-analysis | FileCheck %s --check-prefixes=CHECK-DISABLED
...
; CHECK-NEXT:    ret <vscale x 4 x i32> [[ADD]]
;
; CHECK-DISABLED-LABEL: @load_store_clobber_load_noalias(
; CHECK-DISABLED-NEXT:    [[LOAD1:%.*]] = load <vscale x 4 x i32>, <vscale x 4 x i32>* [[P:%.*]], align 16
; CHECK-DISABLED-NEXT:    store <vscale x 4 x i32> zeroinitializer, <vscale x 4 x i32>* [[P2:%.*]], align 16
; CHECK-DISABLED-NEXT:    [[LOAD2:%.*]] = load <vscale x 4 x i32>, <vscale x 4 x i32>* [[P]], align 16
; CHECK-DISABLED-NEXT:    [[ADD:%.*]] = add <vscale x 4 x i32> [[LOAD1]], [[LOAD2]]
; CHECK-DISABLED-NEXT:    ret <vscale x 4 x i32> [[ADD]]
  %load1 = load <vscale x 4 x i32>, <vscale x 4 x i32>* %p
  store <vscale x 4 x i32> zeroinitializer, <vscale x 4 x i32>* %p2
  %load2 = load <vscale x 4 x i32>, <vscale x 4 x i32>* %p ; <- load to be eliminated
  %add = add <vscale x 4 x i32> %load1, %load2
