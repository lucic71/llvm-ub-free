...
; RUN: opt < %s -aa-pipeline=basic-aa -passes=dse -S -disable-object-based-analysis | FileCheck %s --check-prefixes=CHECK-DISABLED
...
; CHECK-NEXT:    ret void
;
; CHECK-DISABLED-LABEL: @test17(
; CHECK-DISABLED-NEXT:    tail call void @llvm.memset.p0i8.i64(i8* [[P:%.*]], i8 42, i64 8, i1 false)
; CHECK-DISABLED-NEXT:    tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* [[P]], i8* [[Q:%.*]], i64 12, i1 false)
